...
function vp_setup() {
	 ...
	 * If you're building a theme based on vp, use a find and replace
...
function vp_scripts() {
	...
	wp_enqueue_script( 'vp-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206', true );

	wp_enqueue_script( 'vp-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20130115', true );
